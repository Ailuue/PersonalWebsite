export const DATA = {
  ...
  phone: '+886 909 084 078',
  linkedin: 'alexander-vervloet',
  skills: [
    { group: 'core', items: ['JavaScript / TypeScript', 'React · React Native', 'Node.js · NestJS', 'REST · GraphQL'] },
    { group: 'domain', items: ['Web3 / Blockchain', 'Payment systems', 'Unit / E2E testing', 'UI / UX feedback'] },
    { group: 'strengths', items: ['Technical communication', 'Cross-team collaboration', 'Product-minded thinking', 'Explaining complexity simply'] },
    { group: 'workflow', items: ['Agile · Scrum · Jira', 'Independent execution', 'Remote-native (since 2017)', 'Async-first'] },
  ],
  experience: [
    {
      co: 'VeVe',
