...
export function Page() {
  ...
  return (
    ...
    >
      <Grid containerRef={containerRef} width={GRID_WIDTH} height={GRID_HEIGHT} />
      ...
      <div style={{
        ...
        padding: '18px 56px', borderBottom: `1px solid ${P.line}`,
      ...
      <section style={{
        ...
        <div>
          <div style={{ color: P.accent, fontSize: 11, letterSpacing: '0.22em', textTransform: 'uppercase', marginBottom: 28 }}>
            &gt; whoami
          </div>
          <h1 className="sans" style={{
            fontSize: 72, fontWeight: 500, margin: 0, lineHeight: 1.02,
            letterSpacing: '-0.02em', color: P.ink,
          }}>
            Alexander<br />
            <span style={{ color: P.accent }}>Vervloet</span><span style={{ color: P.mute }}>.</span>
          </h1>
          <div className="sans" style={{
            marginTop: 20, fontSize: 20, color: P.dim, fontWeight: 300,
            letterSpacing: '-0.005em', minHeight: 32,
          }}>
            {booted && (
              <Typewriter
          ...
          <p className="sans" style={{
            marginTop: 36, fontSize: 16, lineHeight: 1.65, color: P.ink,
            maxWidth: 560, opacity: introDone ? 1 : 0, transition: 'opacity 0.6s',
          }}>
          ...
          <div style={{
            ...
            <a href={`https://github.com/${DATA.github}`} target="_blank" rel="noreferrer" className="btn-link" style={{ color: P.ink }}>
              Github <span>↗</span>
            </a>
          </div>
        </div>
        ...
        <div>
          <Portrait />
          <div style={{
            marginTop: 20, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1,
            background: P.line, border: `1px solid ${P.line}`,
          }}>
            {([
              ['7y', 'shipping prod'],
              ['2M', 'users reached'],
      ...
      {/* ─── ABOUT ─── */}
      <section style={{ position: 'relative', zIndex: 2, padding: '56px 56px 64px', borderTop: `1px solid ${P.line}` }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 56, marginTop: 40 }}>
          <div className="sans" style={{ fontSize: 16, lineHeight: 1.7, color: P.ink }}>
            <p style={{ margin: '0 0 20px' }}>
              ...
              <span style={{ color: P.accent }}>why</span> we were building them, whether we were building the{' '}
              <span style={{ color: P.accent }}>right</span> thing, and how to explain the answer to someone who had never written a line of code.
            </p>
      ...
      {/* ─── EXPERIENCE ─── */}
      <section id="experience" style={{ position: 'relative', zIndex: 2, padding: '56px 56px 64px', borderTop: `1px solid ${P.line}` }}>
        <SectionHead num="02" label="experience" title="Seven years. One long streak." />
        <div style={{ marginTop: 40 }}>
          {DATA.experience.map((job, i) => (
            <div key={i} style={{
              ...
              <div>
                <div className="sans" style={{ fontSize: 22, color: P.ink, fontWeight: 500, letterSpacing: '-0.005em' }}>
      ...
      <section style={{ position: 'relative', zIndex: 2, padding: '56px 56px 64px', borderTop: `1px solid ${P.line}` }}>
        ...
        <div style={{ marginTop: 24, textAlign: 'center' }}>
          <a href={`https://github.com/${DATA.github}`} target="_blank" rel="noreferrer" className="btn-link" style={{ color: P.dim }}>
      ...
      {/* ─── EARLIER + LANGUAGES ─── */}
      <section style={{
        position: 'relative', zIndex: 2, padding: '56px 56px 64px', borderTop: `1px solid ${P.line}`,
        display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 56,
      }}>
        <div>
          ...
          <p className="sans" style={{ fontSize: 16, lineHeight: 1.7, color: P.ink, maxWidth: 560, marginTop: 24 }}>
            <span style={{ color: P.accent }}>The discipline of making complex things genuinely simple for people with no prior context</span> has turned out to be the single most useful thing I do.
          </p>
        </div>
        <div>
          <div style={{ color: P.accent, fontSize: 10, letterSpacing: '0.22em', textTransform: 'uppercase', marginBottom: 16 }}>
          ...
          <dl className="kv sans" style={{ color: P.ink }}>
            ...
            <dt>中文 Mandarin</dt><dd>Intermediate <span style={{ color: P.mute }}>· self-taught, 12 years in TW</span></dd>
          </dl>
      ...
      {/* ─── CONTACT ─── */}
      <section style={{
        position: 'relative', zIndex: 2, padding: '80px 56px 96px',
        ...
        <div style={{ marginTop: 40, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 56 }}>
          <div>
            <p className="sans" style={{ fontSize: 18, lineHeight: 1.55, color: P.ink, margin: 0, maxWidth: 480 }}>
              I&apos;m open to remote senior frontend roles with teams who value communication as much as code. UTC+8, flexible overlap with US and EU.
            </p>
          </div>
          <div>
            <dl className="kv sans" style={{ color: P.ink, fontSize: 15 }}>
              <dt>Email</dt>
              <dd style={{ fontFamily: 'IBM Plex Mono, monospace', color: P.accent }}>{DATA.emailEncoded}</dd>
              <dt>Phone</dt>
              <dd style={{ fontFamily: 'IBM Plex Mono, monospace' }}>{DATA.phone}</dd>
              <dt>LinkedIn</dt>
              <dd>
