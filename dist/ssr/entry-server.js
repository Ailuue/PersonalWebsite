...
function gridPointsInRect(x0, y0, x1, y1, width, height) {
  const pts = []
...
function Grid({ containerRef, width, height }) {
  ...
  useEffect(() => {
    ...
    const render2 = () => {
      ...
      if (prev.x > -9e3) {
        ...
        ctx.fillStyle = 'rgba(127, 184, 168, 0.14)'
        for (const [gx, gy] of gridPointsInRect(
          x0,
          y0,
          x1,
          y1,
  ...
  useEffect(() => {
    ...
    const run = async () => {
      for (let i = 0; i < BOOT_LINES.length; i++) {
        await new Promise((r) =>
          setTimeout(r, BOOT_LINES[i].delay + (i === 0 ? 300 : 180)),
        )
        if (cancelled) return
    ...
    children: [
      ...
      visible.map((line, i) =>
        /* @__PURE__ */ jsxs(
          'div',
          {
            style: { color: line.includes('[ ok ]') ? P.ink : P.accent },
            children: [
              /* @__PURE__ */ jsx('span', {
                style: { color: P.mute, marginRight: 12 },
      ...
      visible.length < BOOT_LINES.length &&
        /* @__PURE__ */ jsxs('span', {
          ...
          children: [
            /* @__PURE__ */ jsx('span', {
              style: { color: P.mute, marginRight: 12 },
              children: String(visible.length).padStart(2, '0'),
            }),
    ...
    children: [
      /* @__PURE__ */ jsxs('div', {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx('span', {
            style: { flex: 1, height: 1, background: P.line, opacity: 0.6 },
          }),
        ],
      }),
      /* @__PURE__ */ jsx('h2', {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx('span', {
                  style: { color: P.mute },
                  children: 'drop /portrait.duotone.jpg in public/',
                }),
              ],
            }),
          ],
...
function Page() {
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      ...
      booted && /* @__PURE__ */ jsx(Crosshair, { containerRef }),
        ...
        children: [
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs('span', {
                children: ['session ', booted ? 'active' : 'booting'],
              }),
            ],
          }),
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs('span', {
                style: { color: P.accent },
                children: ['● ', DATA.status.toLowerCase()],
              }),
            ],
          }),
        ],
              ...
              /* @__PURE__ */ jsx('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs(
                    'div',
                    {
                      style: { background: P.bg, padding: '14px 16px' },
                      children: [
                        /* @__PURE__ */ jsx('div', {
                          className: 'sans',
                          style: {
              ...
              /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsx('div', {
                    ...
                    children: "// the part AI doesn't replace",
                  }),
                  /* @__PURE__ */ jsx('ul', {
                    className: 'sans',
                    style: {
                      ...
                      children: [
                        /* @__PURE__ */ jsxs('div', {
                          ...
                          children: [
                            ...
                            ' ',
                            /* @__PURE__ */ jsx('span', {
                              style: { color: P.mute, fontWeight: 300 },
                              children: '·',
                            }),
                            ' ',
                            /* @__PURE__ */ jsx('span', {
      ...
      /* @__PURE__ */ jsxs('section', {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx('div', {
            ...
            children: DATA.skills.map((col) =>
              /* @__PURE__ */ jsxs(
                'div',
                {
                  style: { background: P.bg, padding: 24 },
                  children: [
                    /* @__PURE__ */ jsxs('div', {
                      style: {
                        color: P.accent,
                    ...
                    /* @__PURE__ */ jsx('ul', {
                      ...
                      children: col.items.map((s, i) =>
                        /* @__PURE__ */ jsx('li', { children: s }, i),
                      ),
                    }),
                  ],
                },
      ...
      /* @__PURE__ */ jsxs('section', {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx('div', {
            ...
            children: DATA.projects.map((proj, i) =>
              /* @__PURE__ */ jsx(ProjectCard, { proj }, i),
            ),
          }),
          /* @__PURE__ */ jsx('div', {
              ...
              /* @__PURE__ */ jsxs('p', {
                ...
                children: [
                  /* @__PURE__ */ jsx('span', {
                    style: { color: P.accent },
                    children:
                      'The discipline of making complex things genuinely simple for people with no prior context',
                  }),
                  ' ',
            ...
            children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs('dd', {
                    children: [
                      ...
                      /* @__PURE__ */ jsx('span', {
                        style: { color: P.mute },
                        children: '· self-taught, 12 years in TW',
                      }),
                    ],
                  }),
                ],
              ...
              /* @__PURE__ */ jsxs('dl', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx('dd', {
                    children: 'Communication — Speech, Rhetoric, Leadership',
                  }),
                  /* @__PURE__ */ jsx('dt', { children: 'School' }),
                  /* @__PURE__ */ jsx('dd', {
                    children: 'Oregon State University, 2014',
                  }),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx('span', {
                children: 'build 2026.04 — v1 graphite',
              }),
          ...
          /* @__PURE__ */ jsxs('div', {
            children: [
              /* @__PURE__ */ jsxs('div', {
                ...
                children: ['github.com/', DATA.github, '/'],
              }),
              /* @__PURE__ */ jsx('div', {
                className: 'sans',
                style: {
...
function App() {
  return /* @__PURE__ */ jsx('div', {
    style: { background: '#0e1113', minHeight: '100vh' },
